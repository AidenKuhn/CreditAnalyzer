...
export declare namespace FHEAnonymousCrowdfunding {
...
export interface FHEAnonymousCrowdfundingInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "PLATFORM_FEE"
      | "campaignCounter"
  ...
  encodeFunctionData(
    functionFragment: "getAnonymousStats",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface FHEAnonymousCrowdfunding extends BaseContract {
  connect(runner?: ContractRunner | null): FHEAnonymousCrowdfunding;
  waitForDeployment(): Promise<this>;

  interface: FHEAnonymousCrowdfundingInterface;
  ...
  getAllActiveCampaigns: TypedContractMethod<
    [],
    [FHEAnonymousCrowdfunding.CampaignStructOutput[]],
    "view"
  >;

  getAnonymousStats: TypedContractMethod<
    [_campaignId: BigNumberish],
    [
      [bigint, bigint, bigint] & {
        anonymousDonations: bigint;
        publicDonations: bigint;
        totalDonationCount: bigint;
      }
    ],
    "view"
  >;
  ...
  getCampaignDonations: TypedContractMethod<
    [_campaignId: BigNumberish],
    [FHEAnonymousCrowdfunding.DonationStructOutput[]],
    "view"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "getAnonymousStats"
  ): TypedContractMethod<
    [_campaignId: BigNumberish],
    [
      [bigint, bigint, bigint] & {
  ...
  filters: {
    "CampaignCreated(uint256,address,string,uint256,uint256,bool)": TypedContractEvent<
      CampaignCreatedEvent.InputTuple,
      CampaignCreatedEvent.OutputTuple,
      CampaignCreatedEvent.OutputObject
    >;
